...
public class UsersListTest {
	...
	public void user_is_on_requested_url() {
	  RestAssured.baseURI="https://reqres.in/";
	  req=RestAssured.given();
	  System.out.println("Given step is completed");
	}
	...
	public void all_the_users_is_displayed() {
	 ...
	 Assert.assertEquals(id, "8","Id is mismatched");
	 System.out.println("Then step is completed");
	}
