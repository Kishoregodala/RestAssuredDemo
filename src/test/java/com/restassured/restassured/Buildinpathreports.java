...
public class Buildinpathreports {
		...
		public void init()
		{
			...
			//report=new ExtentReports("C:\\Reports\\ReportTest.html");
			report=new ExtentReports("./target/Report/ApiTest.html");
			test=report.startTest("Adding the user to excel & creating users");
		}
		  ...
		  JSONObject obj=new JSONObject();
			...
			System.out.println(obj);
			 ...
			 if(job.equals(jobdata))
			 {
				 ...
				 test.log(LogStatus.FAIL, "Data is valid for expected "+job+" and actual "+jobdata);
			 }
	  }
	  @AfterTest
